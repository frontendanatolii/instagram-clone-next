...
export default function Suggestions() {
  ...
  const onSeeAll = () => {
    if (isSeeAllOpen) {
      setSuggestions((prevState) => prevState.slice(0, 5));
      setIsSeeAllOpen(false);
        ...
        setSuggestions((prevState) => [...prevState, ...suggestions]);
  ...
  return (
    <div className="mt-4 ml-10">
      <div className="flex justify-between mb-5 text-sm">
        ...
        <button className="text-gray-600 font-semibold" onClick={onSeeAll}>
          {isSeeAllOpen ? 'Show less' : 'See all'}
        </button>
      </div>
